...
const Home = () => {
    ...
    return (
        <>
            <Container>
                <Grid container spacing={2} justifyContent="flex-start" alignItems="center" style={{ marginTop: "50px" }}>
                    <Grid item xs={12}>
                        <Item style={{ boxShadow: 0 }} sx={{ border: 0, boxShadow: 0 }}>
                            <Typography variant="h2" style={{ marginTop: "30px", marginBottom: "0px", textAlign: "center", color: "black" }}>My Goals</Typography>
                        </Item>
                    </Grid>
                </Grid>
                        ...
                        <Item sx={{ height: '100%' }}>
                            ...
                            <Grid container spacing={3}>
                                <Grid item xs={12} md={4}>
                                    <Item sx={{ height: '100%' }}>
                                        ...
                                        <Box sx={{ position: 'relative', display: 'inline-flex' }} style={{ marginTop: '20px' }}>
                                            <CircularProgress variant="determinate" size={70} thickness={5} value="90" />
                                            <Box
                                                sx={{
                                                    top: 0,
                                                    left: 0,
                                ...
                                <Grid item xs={12} md={12}>
                                    <Item sx={{ height: '100%' }}>
                                        <Typography variant="h6" style={{ color: "black", textAlign: "left", paddingLeft: '10px' }}>Description</Typography>
            ...
            <Container>
                <Grid container spacing={2} justifyContent="flex-start" alignItems="center" style={{ marginTop: "50px" }}>
                    <Grid item xs={12} md={11}>
                        <Item style={{ boxShadow: 0 }} sx={{ border: 0, boxShadow: 0 }}>
                            <Typography variant="h4" style={{ marginTop: "10px", marginBottom: "30px", textAlign: "left", color: "black" }}>Non-Habitual Goals</Typography>
                        </Item>
                    </Grid>
                    <Grid item xs={12} md={1}>
                        <Item style={{ boxShadow: 0 }} sx={{ border: 0, boxShadow: 0 }}>
                ...
                <Grid container spacing={3}>
                    {goals.map((goal) => (
                        <Grid item xs={6} md={4}>
                            <Item>
                                <Typography variant="h6" justifyContent="flex-start" style={{ marginTop: '1px', marginBottom: '20px' }}>Goal 1</Typography>
                                ...
                                <Typography variant="body1" gutterBottom style={{ textAlign: 'justify', marginTop: '20px' }}>
